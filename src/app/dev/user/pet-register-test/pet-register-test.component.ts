...
@Component({
  selector: 'app-pet-register-test',
  templateUrl: './pet-register-test.component.html',
  styleUrls: ['./pet-register-test.component.scss']
})
export class PetRegisterTestComponent implements OnInit {
   // petForm
   petForm: FormGroup;
